...
*/
-- DropForeignKey
ALTER TABLE "public"."Like" DROP CONSTRAINT "Like_sourceUserId_fkey";

-- DropForeignKey
ALTER TABLE "public"."Like" DROP CONSTRAINT "Like_targetUserId_fkey";
...
-- AddForeignKey
ALTER TABLE "public"."Like" ADD CONSTRAINT "Like_sourceMemberId_fkey" FOREIGN KEY ("sourceMemberId") REFERENCES "public"."Member"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."Like" ADD CONSTRAINT "Like_targetMemberId_fkey" FOREIGN KEY ("targetMemberId") REFERENCES "public"."Member"("id") ON DELETE CASCADE ON UPDATE CASCADE;
